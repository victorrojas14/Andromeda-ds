 ...
 *       'Display 3': 'display-3', 'Display 4': 'display-4',
 *       H1: 'h1', H2: 'h2', H3: 'h3', H4: 'h4', H5: 'h5', H6: 'h6',
 *       Parrafo: 'parrafo', 'Parrafo-SM': 'parrafo-sm',
 *       'Parrafo-XS': 'parrafo-xs', 'Small 1': 'small-1', 'Small 2': 'small-2',
 *     }),
 *     weight: figma.enum('Weight', {
 *       Regular: 'regular', Medium: 'medium', 'Semi-Bold': 'semibold',
 *     }),
 *     label: figma.string('Texto'),
 *   },
 *   example: (props) => html`
 * <Text variant="${props.variant}" weight="${props.weight}">${props.label}</Text>`,
 *   imports: ["import { Text } from '@andromeda/vue'"],
 * })
 */
