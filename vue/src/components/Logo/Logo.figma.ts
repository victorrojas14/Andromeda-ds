...
figma.connect('https://www.figma.com/design/oTZzdsgGkCjbL2f3oybxD0/Ui-Kit-Web?node-id=7375-5545', {
  props: {
...
<Logo variant="${props.variant}" />`,
  imports: ["import { Logo } from '@andromeda/vue'"],
})

figma.connect('https://www.figma.com/design/oTZzdsgGkCjbL2f3oybxD0/Ui-Kit-Web?node-id=7387-6375', {
  props: {
...
figma.connect('https://www.figma.com/design/oTZzdsgGkCjbL2f3oybxD0/Ui-Kit-Web?node-id=1007-1524', {
  example: () => html`
<Logo variant="invex-renacer" />`,
  imports: ["import { Logo } from '@andromeda/vue'"],
})

figma.connect('https://www.figma.com/design/oTZzdsgGkCjbL2f3oybxD0/Ui-Kit-Web?node-id=806-5988', {
  example: () => html`
<Logo variant="invex-fiduciario" />`,
  imports: ["import { Logo } from '@andromeda/vue'"],
})
